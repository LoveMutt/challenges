...
from challenge02.game import draw_letters, calc_word_value, max_word_value
from challenge02.game import get_possible_dict_words, _get_permutations_draw
from challenge02.game import _validation
